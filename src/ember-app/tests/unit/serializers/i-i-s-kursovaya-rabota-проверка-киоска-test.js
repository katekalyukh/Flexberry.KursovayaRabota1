...
moduleForModel('i-i-s-kursovaya-rabota-проверка-киоска', 'Unit | Serializer | i-i-s-kursovaya-rabota-проверка-киоска', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-проверка-киоска',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
